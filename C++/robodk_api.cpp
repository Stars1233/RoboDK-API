...
bool RoboDK::FileSet(const QString &path_file_local, const QString &file_remote, bool load_file, Item *attach_to)
{
    ...
    if (!_send_Line("FileRecvBin"))
    {
        return false;
    }
    QFile file(path_file_local);
    if (!_send_Line(file_remote))
    {
        return false;
    }
    ...
    if (!_send_Item(attach_to))
    {
        return false;
    }
    if (!_send_Int(load_file ? 1 : 0))
    {
        return false;
    }
    if (!_check_status())
...
bool RoboDK::FileGet(const QString &path_file_local, Item *station, const QString path_file_remote)
{
    ...
    if (!_send_Line("FileSendBin"))
    {
        return false;
    }
    if (!_send_Item(station))
    {
        return false;
    }
    if (!_send_Line(path_file_remote))
    {
        return false;
    }
...
QString RoboDK::_recv_Line(QAbstractSocket* com)
{
    if (com == nullptr)
    {
        com = _COM;
...
int RoboDK::_recv_Int(QAbstractSocket* com)
{
    if (com == nullptr)
    {
        com = _COM;
...
Item RoboDK::_recv_Item(QAbstractSocket* com)
{
    if (com == nullptr)
    {
        com = _COM;
...
Mat RoboDK::_recv_Pose(QAbstractSocket* com)
{
    if (com == nullptr)
    {
        com = _COM;
...
bool RoboDK::_recv_Array(double *values, int *psize, QAbstractSocket* com)
{
    ...
    if (nvalues < 0 || nvalues > 50) //check if the value is not too big
    {
        return false;
    }
...
bool RoboDK::_recv_Matrix2D(tMatrix2D **mat)
{
    // needs to delete after!
